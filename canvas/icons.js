/**
 * Created by david on 2014-07-22.
 */
...
(function () {
    ...
    var rock = new icon("rock");
    rock.draw(borderRock, detailsRock);
    ...
    var paper = new icon("paper");
    paper.draw(borderPaper, detailsPaper);
    ...
    var scisor = new icon("scisor");
    scisor.draw(borderScisor, detailsScisor);
    ...
    var lizard = new icon("lizard");
    lizard.draw(borderLizard, detailsLizard);
